...
export const functionalKasir = [
  ...
  new functionalMenu('Reset Password Member','Fitur ini mendukung pegawai melayani member yang ingin melakukan reset password karena lupa','../../src/assets/image/reset-password.jpg','reset-password-member', 'reset-password-member'),
...
export const functionalMO = [
  ...
  new functionalMenu('Perijinan Instruktur','Fitur pengolah data Admin, Admin bisa menambahkan data instruktur, mengupdate, menampilkan dan menghapus data instruktur','../../src/assets/image/perijinan.jpeg','ijin-instruktur'),
