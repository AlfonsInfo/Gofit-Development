...
import { HomeNavbar, useRouter,  $toast, defineComponent, BackButton ,ref } from '@/plugins/global.js'
  ...
  export default defineComponent({  
    ...
    methods :{
        ...
        async getDataKinerjaInstruktur(message,bulan = null){
            const url = "/laporankinerjainstruktur";
    ...
    async mounted(){
        //8 belum digroup perbulan
        this.selectedMonth = this.getMonth();
        await this.getDataKinerjaInstruktur('Berhasil Mengambil Data Kinerja Instruktur Bulanan' ,this.selectedMonth );
...
<template >
  <header>
    <home-navbar :message="'Gofit - Laporan Instruktur Bulanan'"></home-navbar>
  </header>
  <main>
    <div class="container mt-5">
      ...
      <div class="content bg-white text-dark table-custom m-5 mt-2">
        <div  class="container-fluid  p-4">
            <h3 >Tabel Laporan Kinerja Instruktur Bulanan</h3>
            ...
            <table id="example" class="#example table table-striped filters" style="width:100%;">
                <thead>
                    <tr>
                        ...
                        <!-- TODO count presensi -->
                        <th>Jumlah Hadir</th> 
                        <!-- TODO count jumlah libur (count izin) -->
                        <th>Jumlah Libur</th>
                        <!-- TODO Akumulasi terlambat di member  -->
